...
<body class="new">
    <div class="container-xl">
        <section class="footer__ row">
            <div class="footer__menu border col-sm-12 col-md-6">
            ...
            <div class="footer__contacts border col-sm-12 col-md-6">
            ...
            <div class="col-xl-10">
                <div class="row">
                    <div class="footer__menu col-5">
                    </div>
                    <div class="col-7">
                        <div class="row">
                            <div class="footer__email col-md-6 col-sm-12 d-sm-flex flex-sm-column align-items-sm-end">
